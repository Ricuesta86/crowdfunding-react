    ...
    <main className='main'>
      ...
      <div className='main__mastrercraft'>
        <section className='main__mastrercraft__section'>
          <img className='main__mastrercraft__section__logo' src="./images/logo-mastercraft.svg" alt="Logo mastercraft" />
          <h1 className='main__mastrercraft__section__title'>Mastercraft Bamboo Monitor Riser</h1>
          <p className='text'>A beautiful & handcrafted monitor stand to reduce neck and eye strain.</p>
          <div>
            <button className='btn'>Back this project</button>
            <button><img src="./images/icon-bookmark.svg" alt="Bookmark" />Bookmark</button>
          </div>
        </section>
        <section>
          <div>
